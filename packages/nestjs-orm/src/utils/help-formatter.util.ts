/**
 * Help Formatter Utility
 *
 * Provides custom help formatting for CLI commands with grouped display.
 * Groups commands by category for better organization and readability.
 */
