...
export const FeaturesThreeCentered: React.FC<FeaturesWithHeaderProps> = ({
  heading,
  description,
  features,
  className,
  ...
  return (
    <Section spacing="md" className={className}>
      ...
      <Row className="mt-[16px]">
        {(features as FeatureItem[]).slice(0, 3).map((feature, idx) => (
          <Column key={idx} align="center" className="w-1/3 pl-[12px] align-baseline">
