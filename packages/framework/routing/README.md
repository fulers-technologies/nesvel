# @nesvel/nestjs-routing

A comprehensive, enterprise-ready routing decorator for NestJS REST API
endpoints that combines all necessary decorators into one.

## Installation

```bash
bun add @nesvel/nestjs-routing
# or
npm install @nesvel/nestjs-routing
# or
yarn add @nesvel/nestjs-routing
```
