...
export class OrderController {
  ...
  async findOne(@Param('id') id: string) {
    ...
    return await this.orderService.findOneOrFail(parseInt(id, 10));
  }
  ...
  async update(
    ...
    return await this.orderService.update(parseInt(id, 10), updateOrderDto);
  }
  ...
  async remove(@Param('id') id: string) {
    ...
    await this.orderService.delete(parseInt(id, 10));
