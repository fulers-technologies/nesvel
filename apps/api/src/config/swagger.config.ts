import type { SwaggerConfig } from '@nesvel/nestjs-swagger';
import { SwaggerThemeNameEnum } from '@nesvel/nestjs-swagger';
...
3. Test directly in the browser`,
  ...
  additionalServers: process.env.SWAGGER_ADDITIONAL_SERVERS
    ...
    : [
        ...
        {
          url: process.env.BETA_API_URL || 'https://beta-api.nesvel.com',
  ...
  branding: {
     ...
     */
    theme: (process.env.SWAGGER_THEME as SwaggerThemeNameEnum) || SwaggerThemeNameEnum.NEWSPAPER,
     ...
     * @optional
     */
    logoUrl: process.env.SWAGGER_LOGO_URL || 'https://mikro-orm.io/img/logo.svg',
  },
